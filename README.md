...
| `compact` | int | 0 | **0:** Each dependency is it's own command with multiline expansion. <br> **1:** Each dependency is it's own command in a single line. <br> **2:** Dependencies are set in a single line. | `1` |