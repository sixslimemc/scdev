...
The function `scdev:-/dev/fetch_dependencies` takes a set of pack IDs and generates copyable commands that would properly set the `dependencies` key in a manifest function based on the world's installed datapacks and their versions.
