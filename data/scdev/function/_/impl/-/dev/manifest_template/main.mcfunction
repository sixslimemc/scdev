...
data modify storage scdev:_ v.template.lines append value '# Identity:'
...
data modify storage scdev:_ v.template.lines append value ''
data modify storage scdev:_ v.template.lines append value '# Load Specification:'
...
data modify storage scdev:_ v.template.lines append value 'data modify storage slimecore:in manifest.pack.contract_declarations set value []'
data modify storage scdev:_ v.template.lines append value 'data modify storage slimecore:in manifest.pack.contracts_satisfied set value []'
data modify storage scdev:_ v.template.lines append value ''
