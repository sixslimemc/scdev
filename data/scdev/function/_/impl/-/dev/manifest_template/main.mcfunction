...
execute if score *template.format _scdev matches 0 run data modify storage scdev:_ v.template.lines append value '# data modify storage slimecore:in manifest.pack.display.links.author set value "https://github.com/GITHUB_USER"'
execute if score *template.format _scdev matches 0 run data modify storage scdev:_ v.template.lines append value '# data modify storage slimecore:in manifest.pack.display.links.versions set value "https://github.com/GITHUB_USER/GITHUB_REPO/releases"'
data modify storage scdev:_ v.template.lines append value ''
