...
data modify storage scdev:_ v.reference.lines append value {text:"│    │ │ └", color:dark_gray, extra:[{text:"<id>", color:dark_purple, italic:true}, {text:".json", color:dark_purple, italic:false}, {text:" (...)", color:dark_blue}]}
