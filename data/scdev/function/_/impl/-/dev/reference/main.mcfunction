...
data modify storage scdev:_ v.reference.lines append value {text:"│    │ │ └", color:dark_gray, extra:[{text:"<entrypoint id>", color:gold, italic:true}, {text:".json", color:gold, italic:false}, {text:" (...)", color:dark_blue}]}
