...
data modify storage scdev:_ v.reference.lines append value {text:"│    │ │ └", color:dark_gray, extra:[{text:"<id>", color:gold, italic:true}, {text:".json", color:gray, italic:false}, {text:" (...)", color:white}]}
data modify storage scdev:_ v.reference.lines append value {text:"│    │ ├ ", color:dark_gray, extra:[{text:"preload_entrypoint", color:gray}]}
data modify storage scdev:_ v.reference.lines append value {text:"│    │ │ └", color:dark_gray, extra:[{text:"<id>", color:dark_purple, italic:true}, {text:".json", color:gray, italic:false}, {text:" (...)", color:white}]}
