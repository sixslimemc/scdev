...
# title:
data modify storage scdev:_ v.packs.c.title set value {text:"List: Packs", color:yellow, hover_event:{action:"show_text", value:{text:"", color:white, extra:[{text:"Count: "}, {text:"(all)", color:dark_gray}, {text:"\nPage: "}, {plain:true, storage:"scdev:_", nbt:"v.packs.args.page", color:gray}, {text:"\nGet: "}, {text:"Enabled", color:green}, {text:"\nPack Filter: "}, {text:"(none)", color:dark_gray}]}}}
execute if data storage scdev:_ v.packs.args.count run data modify storage scdev:_ v.packs.c.title.hover_event.value.extra[1] set value {plain:true, storage:"scdev:_", nbt:"v.packs.args.count", color:gray}
execute if data storage scdev:_ v.packs.args{disabled:true} run data modify storage scdev:_ v.packs.c.title.hover_event.value.extra[5] set value {text:"Disabled", color:red}
