...
data modify storage scdev:_ x.mline set value {1:"data modify storage scdev:_ v.preload_entrypoints.index set from storage slimecore:data build.order.entrypoints[{pack_ref:'", 2:true, 3:"'}].index"}
