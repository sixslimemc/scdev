...
data modify storage scdev:in dependency.declaration set from storage scdev:_ v.packinfo.dependencies[-1]
...
data remove storage scdev:_ v.packinfo.dependencies[-1]
