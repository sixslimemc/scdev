...
data modify storage scdev:in pack.reference.pack_ref set from storage scdev:_ v.packinfo.dependents[-1]
...
data remove storage scdev:_ v.packinfo.dependents[-1]
