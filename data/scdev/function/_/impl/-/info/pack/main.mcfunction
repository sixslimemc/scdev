...
execute unless data storage scdev:_ v.packinfo.dependencies[0] run data modify storage scdev:_ v.packinfo.lines[-1][0] merge value {strikethrough:false, color:white, italic:false}
...
execute unless data storage scdev:_ v.packinfo.dependents[0] run data modify storage scdev:_ v.packinfo.lines[-1][0] merge value {strikethrough:false, color:white, italic:false}
...
execute unless data storage scdev:_ v.packinfo.preloads[0] run data modify storage scdev:_ v.packinfo.lines[-1][0] merge value {strikethrough:false, color:white, italic:false}
...
execute unless data storage scdev:_ v.packinfo.entrypoints[0] run data modify storage scdev:_ v.packinfo.lines[-1][0] merge value {strikethrough:false, color:white, italic:false}
...
execute unless data storage scdev:_ v.packinfo.interfaces[0] run data modify storage scdev:_ v.packinfo.lines[-1][0] merge value {strikethrough:false, color:white, italic:false}
...
execute unless data storage scdev:_ v.packinfo.implements[0] run data modify storage scdev:_ v.packinfo.lines[-1][0] merge value {strikethrough:false, color:white, italic:false}
