...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Interface Implementations:", color:white}]
...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Interface Declarations:", color:white}]
