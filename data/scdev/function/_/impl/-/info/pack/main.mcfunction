...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Abs. Implements:", color:white}]
...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Abs. Declares:", color:white}]
