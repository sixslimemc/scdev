...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Implementations:", color:white}]
...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Interfaces:", color:white}]
