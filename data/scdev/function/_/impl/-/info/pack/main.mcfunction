...
data modify entity @s text set value [{text:"ID: ", color:"gray"}, {interpret:true, storage:"scdev:out", nbt:"pack.result"}]
...
data modify entity @s text set value [{text:"Version: ", color:"gray"}, {interpret:true, storage:"scdev:out", nbt:"version.result"}]
data modify storage scdev:_ v.packinfo.lines append from entity @s text

# is library:
data modify storage scdev:_ x.line set value [{text:"Is Library: ", color:gray}]
...
# enabled status:
data modify storage scdev:_ v.packinfo.lines append value [{text:"World Status: ", color:gray}]
...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Dependencies: ", color:gray}]
...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Dependents: ", color:gray}]
...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Preload Entrypoints: ", color:gray}]
...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Entrypoints: ", color:gray}]
...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Abstract Declarations: ", color:gray}]
...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Abstract Implementations: ", color:gray}]
...
# display:
data modify storage scdev:_ v.packinfo.lines append value {text:"Display Info:", color:gray}

data modify storage scdev:_ v.packinfo.lines append value [{text:"  Name: ", color:gray}, {text:"NAME", color:white}]
...
data modify storage scdev:_ v.packinfo.lines append value [{text:"  Author: ", color:gray}, {text:"AUTHOR", color:blue}]
data modify storage scdev:_ v.packinfo.lines[-1][1].text set from storage scdev:_ v.packinfo.entry.pack.display.author_name

# links:
data modify storage scdev:_ v.packinfo.lines append value [{text:"Ext. Links: ", color:dark_gray}, {text:"Info"}, {text:" "}, {text:"Author"}, {text:" "}, {text:"Versions"}]
...
execute if data storage scdev:_ v.packinfo.entry.pack.display.links.info run data modify storage scdev:_ v.packinfo.lines[-1][1] merge value {underlined:true, color:gold, hover_event:{action:"show_text", value:[{text:"Click to open URL", color:gray}]}, click_event:{action:"open_url", url:"URL"}}
...
execute if data storage scdev:_ v.packinfo.entry.pack.display.links.author run data modify storage scdev:_ v.packinfo.lines[-1][3] merge value {underlined:true, color:gold, hover_event:{action:"show_text", value:[{text:"Click to open URL", color:gray}]}, click_event:{action:"open_url", url:"URL"}}
...
execute if data storage scdev:_ v.packinfo.entry.pack.display.links.versions run data modify storage scdev:_ v.packinfo.lines[-1][5] merge value {underlined:true, color:gold, hover_event:{action:"show_text", value:[{text:"Click to open URL", color:gray}]}, click_event:{action:"open_url", url:"URL"}}
...
# download button:
data modify storage scdev:_ v.packinfo.lines append value {text:"[Direct Download]", color:aqua, underlined:true, hover_event:{action:"show_text", value:[{text:"Click to open URL", color:gray}]}, click_event:{action:"open_url", url:"URL"}}
