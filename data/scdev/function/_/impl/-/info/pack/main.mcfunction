...
data modify entity @s text set value [{text:"--[ ", color:"white", bold:true}, {interpret:true, storage:"scdev:out", nbt:"pack.result", color:white}, {text:" ]----", color:"white", bold:true}]
