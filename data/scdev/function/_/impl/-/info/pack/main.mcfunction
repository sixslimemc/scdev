...
data modify storage scdev:_ v.packinfo.implements set from storage scdev:_ v.packinfo.entry.pack.contracts_satisfied
...
data modify storage scdev:_ v.packinfo.interfaces set from storage scdev:_ v.packinfo.entry.pack.contract_declarations
