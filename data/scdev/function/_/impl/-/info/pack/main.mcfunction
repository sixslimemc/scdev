...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Implements Interfaces:", color:white}]
...
data modify storage scdev:_ v.packinfo.lines append value [{text:"Declares Interfaces:", color:white}]
