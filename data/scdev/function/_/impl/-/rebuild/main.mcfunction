...
execute if score *x _scdev matches 0 run return run function scdev:_/impl/-/rebuild/quick_error {line:{text:"", color:red, extra:[{text:"Argument "}, {text:"args.enable", color:yellow}, {text:" must be a list of pack IDs (e.g. "}, {text:"[a, b, ...]", color:dark_aqua}, {text:")."}]}}
...
execute if score *x _scdev matches 0 run return run function scdev:_/impl/-/rebuild/quick_error {line:{text:"", color:red, extra:[{text:"Argument "}, {text:"args.disable", color:yellow}, {text:" must be a list of pack IDs (e.g. "}, {text:"[a, b, ...]", color:dark_aqua}, {text:")."}]}}
