...
data modify storage scdev:_ v.abstract.text.hover_event set value {action:"show_text", value:{text:"", color:gray, extra:[{text:"Implemented by "}, {}, {text:" in current build"}]}}
