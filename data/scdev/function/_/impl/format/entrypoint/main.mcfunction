...
data modify storage scdev:_ v.entrypoint.text set value {text:"",extra:[{text:"PACK", color:yellow}, {text:">",color:gray}, {text:"ID",color:gold}], hover_event:{action:"show_text", value:{text:"", color:gray, italic:true, extra:[{text:"#"}, {text:"PACK ID"}, {text:":entrypoint/"}, {text:"ID"}]}}}
