...
execute if data storage scdev:_ v.pack.data{is_library:true} run data modify storage scdev:_ v.pack.show.title.color set value dark_aqua
...
execute if data storage scdev:_ v.pack.data{is_library:true} run data modify storage scdev:_ v.pack.c.line1.extra[0].color set value dark_aqua
...
# hover lib line:
data modify storage scdev:_ v.pack.c.libline set value {text:"(Library)", color:dark_gray}
...
execute if data storage scdev:_ v.pack.data{is_library:true} run data modify storage scdev:_ v.pack.show.hover.extra append value {text:"\n"}
execute if data storage scdev:_ v.pack.data{is_library:true} run data modify storage scdev:_ v.pack.show.hover.extra append from storage scdev:_ v.pack.c.libline
data modify storage scdev:_ v.pack.show.hover.extra append value {text:"\n"}
