...
# hover line 3:
data modify storage scdev:_ v.pack.c.line3 set value {text:"AUTHOR NAME", color:gray, italic:true}
...
# hover disabled line:
data modify storage scdev:_ v.pack.c.line_disabled set value {text:"[!] Disabled", color:red, bold:false}
