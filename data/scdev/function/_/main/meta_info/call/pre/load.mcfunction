...
data modify storage scdev:_/in send.lines set value [{text:"", color:gray, italic:true, extra:[{text:"Call: ", italic:false, color:dark_gray}, {text:"#"}, {text:"PACK ID"}, {text:":load"}]}]
