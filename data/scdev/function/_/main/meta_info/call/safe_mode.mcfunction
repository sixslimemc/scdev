...
data modify storage scdev:_ x.text set value [{storage:"scdev:_", nbt:"const.chat_marker",interpret:true}, {text:" Calling: #", color:dark_gray}, {text:"PACK ID", color:gold}, {text:":safe_mode", color:gold}]
