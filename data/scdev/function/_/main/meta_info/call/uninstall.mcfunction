...
data modify storage scdev:_ x.text set value [{storage:"scdev:_", nbt:"const.chat_marker",interpret:true}, {text:" Call: #", color:gray}, {text:"PACK ID", color:gray}, {text:":uninstall", color:gray}]
