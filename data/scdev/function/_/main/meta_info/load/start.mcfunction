...
tellraw @a[tag=scdev.watch] {text:" Preload Entrypoints:", color:white, bold:false}
...
tellraw @a[tag=scdev.watch] {text:" Packs:", color:white, bold:false, bold:true}
...
tellraw @a[tag=scdev.watch] {text:" Entrypoints:", color:white, bold:false}
