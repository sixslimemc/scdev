...
tellraw @a[tag=scdev.watch] {text:" Preload Entrypoints:", color:gray, bold:true}
...
tellraw @a[tag=scdev.watch] {text:" Packs:", color:gray, bold:true, bold:true}
...
tellraw @a[tag=scdev.watch] {text:" Entrypoints:", color:gray, bold:true}
