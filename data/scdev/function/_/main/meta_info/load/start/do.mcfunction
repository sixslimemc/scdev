...
data modify storage scdev:_ t.load.lines append value {text:" Preload Entrypoints:", color:blue, bold:true}
...
data modify storage scdev:_ t.load.lines append value {text:" Packs:", color:blue, bold:true, bold:true}
...
data modify storage scdev:_ t.load.lines append value {text:" Entrypoints:", color:blue, bold:true}
