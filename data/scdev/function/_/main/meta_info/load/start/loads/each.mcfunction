...
[ \
    {text:"  "}, \
    {plain:true, storage: "scdev:_", nbt:"t.load.this_load.index", color: dark_gray}, \
    {text:" - ", color: gray}, \
    {plain:true, storage: "scdev:_", nbt:"t.load.this_load.pack_ref", color: aqua}, \
]
...
[ \
    ...
    {plain:true, storage: "scdev:_", nbt:"t.load.this_load.index", color: dark_gray}, \
    {text:" - ", color: gray}, \
    {plain:true, storage: "scdev:_", nbt:"t.load.this_load.pack_ref", color: "yellow", italic:true}, \
]
