...
tellraw @a[tag=scdev.listener] [{text:" - Multiple packs with id ", color:red}, {plain:true, storage:"scdev:_", nbt:"t.error.this_set.pack_id", color:yellow}, {text:":", color:red}]
