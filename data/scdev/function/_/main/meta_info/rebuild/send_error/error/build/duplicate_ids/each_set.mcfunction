...
tellraw @a[tag=scdev.listener] [{text:" - These packs share the id ", color:red}, {plain:true, storage:"scdev:_", nbt:"t.error.this_set.pack_id", color:gold}, {text:":", color:red}]
