...
data modify storage scdev:_ t.error.lines[-1].extra[1] set from storage scdev:_ t.error.dup_id.in
data modify storage scdev:_ t.error.lines[-1].extra[3] set from storage scdev:_ t.error.dup_id.id
