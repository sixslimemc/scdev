...
tellraw @a[tag=scdev.listener] [{text:" - Manifest for pack with id", color:red}, {plain:true, storage:"scdev:_", nbt:"t.error.entry.pack.pack_id", color:yellow}, {text:" has error(s):"}]
