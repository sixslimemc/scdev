...
execute if data storage scdev:_ t.error.this_entry.error.incompatible_slimecore_version run function scdev:_/main/meta_info/rebuild/send_error/error/build/invalid_packs/incompatible_slimecore_version/send
