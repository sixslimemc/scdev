...
# error line:
data modify storage scdev:_ t.error.lines append value {text:"", color:gray, extra:[{text:"   - SlimeCore version "}, {}, {text:" is required to load this pack, but version "}, {}, {text:" is installed."}]}
