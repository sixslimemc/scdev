...
# error line:
data modify storage scdev:_ t.error.lines append value {text:"", color:gray, extra:[{text:"   - The installed version of SlimeCore is incompatible with this pack (SlimeCore"}, {}, {text:" is required, but "}, {}, {text:" is installed)."}]}
