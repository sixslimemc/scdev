...
# error line:
data modify storage scdev:_ t.error.lines append value {text:"", color:gray, extra:[{text:"   - This pack requires SlimeCore"}, {}, {text:" in order to load (Slimecore "}, {}, {text:" currently installed)."}]}
