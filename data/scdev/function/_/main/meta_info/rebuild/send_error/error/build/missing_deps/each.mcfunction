...
tellraw @s [{text: " - ", color:red}, {storage:"scdev:_", nbt:"t.error.entry.dependency.author_id", color: dark_green}, {text: ".", color:dark_green}, {storage:"scdev:_", nbt:"t.error.entry.dependency.pack_id", color: dark_green}, " ", {storage:"scdev:_", nbt:"t.error.entry.dependency.version.major", color: dark_green}, {text: ".", color:dark_green}, {storage:"scdev:_", nbt:"t.error.entry.dependency.version.minor", color: dark_green}, {text: " required by ", color:red}, {storage:"scdev:_", nbt:"t.error.entry.from", color: yellow}, {text: ".", color:red}]
