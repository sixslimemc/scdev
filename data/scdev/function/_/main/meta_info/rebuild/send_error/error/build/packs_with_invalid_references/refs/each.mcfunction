...
# line:
data modify storage scdev:_ t.error.lines append value {text:"", color:gray, extra:[{text:"   - Key '"}, {text:"KEY", color:white}, {text:"' references a nonexistent "}, "TYPE", {text:" ("}, "REFERENCE", {text:")."}]}
data modify storage scdev:_ t.error.lines[-1].extra[1].text set from storage scdev:_ t.error.this_ref.key
data modify storage scdev:_ t.error.lines[-1].extra[3].text set from storage scdev:_ t.error.type_text
data modify storage scdev:_ t.error.lines[-1].extra[5].text set from storage scdev:_ t.error.ref_text
