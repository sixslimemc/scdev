...
execute if data storage scdev:_ t.error.entry.conflicting_group[0] run function scdev:_/main/meta_info/rebuild/send_error/error/build/preload_conflicts/each_pack