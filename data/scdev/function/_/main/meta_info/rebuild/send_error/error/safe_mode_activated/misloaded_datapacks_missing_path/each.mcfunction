...
execute if data storage scdev:_ t.error.this_entry.path_override run data modify storage scdev:_ t.error.lines append value {text:"", color:gray, italic:true, extra:[{text:"   Expected path "}, {plain:true, storage:"scdev:_", nbt:"t.error.this_entry.path_override", color:white}, {text:" due to path override."}], hover_event:{action:'show_text', value:{text:"", color:gray, italic:false, extra:[{text:"", color:dark_aqua, extra:[{text:"{path_overrides:{"}, {storage:"scdev:_", nbt:"t.error.this_entry.pack.pack_id", plain:true}, {text:":"}, {plain:true, storage:"scdev:_", nbt:"t.error.this_entry.path_override"}, {text:"}}"}]}, {text:" in "}, {text:"slimecore:config", color:yellow}, {text:""}]}}}
