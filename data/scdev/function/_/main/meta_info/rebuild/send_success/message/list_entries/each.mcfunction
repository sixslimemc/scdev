...
# line:
data modify storage scdev:_ t.success.lines append value {text:"", color:gray, extra:[" ", "SYMBOL", " ", "PACK", {text:" ← ", color:dark_gray}, {text:"\"", color:gray}, {text:"PATH", color:gray, italic:true}, {text:"\"", color:gray}]}
