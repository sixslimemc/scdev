...
# line:
data modify storage scdev:_ t.success.lines append value {text:"", color:gray, extra:[" ", "SYMBOL", " ", "PACK", {text:" (", color:dark_gray}, {text:"PATH", color:dark_gray}, {text:")", color:dark_gray}]}
