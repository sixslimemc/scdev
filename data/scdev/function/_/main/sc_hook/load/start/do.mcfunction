#> scdev:_/main/sc_hook/load/start/do
#--------------------
# ../start
#--------------------
kill @s
...
execute if data storage scdev:_ t.load.preloads[0] run function scdev:_/main/sc_hook/load/start/preloads/each
...
execute if data storage scdev:_ t.load.loads[0] run function scdev:_/main/sc_hook/load/start/loads/each
...
execute if data storage scdev:_ t.load.entrypoints[0] run function scdev:_/main/sc_hook/load/start/entrypoints/each
