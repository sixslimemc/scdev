#> scdev:_/main/sc_hook/rebuild/send_error/error/duplicate_ids/each_set
#--------------------
# ./send
#--------------------
...
execute if data storage scdev:_ t.error.this_set.packs[0] run function scdev:_/main/sc_hook/rebuild/send_error/error/build/duplicate_ids/each_pack

data remove storage scdev:_ t.error.sets[-1]
execute if data storage scdev:_ t.error.sets[0] run function scdev:_/main/sc_hook/rebuild/send_error/error/build/duplicate_ids/each_set