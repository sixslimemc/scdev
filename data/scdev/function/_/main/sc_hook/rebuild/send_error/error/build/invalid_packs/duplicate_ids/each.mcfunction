#> scdev:_/main/sc_hook/rebuild/send_error/error/build/invalid_packs/duplicate_ids/each
#--------------------
# ../each
#--------------------
...
execute if data storage scdev:_ t.error.this_entry.error.duplicate_ids[0] run function scdev:_/main/sc_hook/rebuild/send_error/error/build/invalid_packs/duplicate_ids/each