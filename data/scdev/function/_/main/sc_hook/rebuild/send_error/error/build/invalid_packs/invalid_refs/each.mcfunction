#> scdev:_/main/sc_hook/rebuild/send_error/error/build/invalid_packs/invalid_refs/each
#--------------------
# ../each
#--------------------
...
execute if data storage scdev:_ t.error.this_entry.error.invalid_pack_references[0] run function scdev:_/main/sc_hook/rebuild/send_error/error/build/invalid_packs/invalid_refs/each