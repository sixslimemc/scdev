#> scdev:_/main/sc_hook/rebuild/send_error/error/build/invalid_packs/invalid_urls/each
#--------------------
# ../each
#--------------------
...
execute if data storage scdev:_ t.error.this_entry.error.invalid_urls[0] run function scdev:_/main/sc_hook/rebuild/send_error/error/build/invalid_packs/invalid_urls/each