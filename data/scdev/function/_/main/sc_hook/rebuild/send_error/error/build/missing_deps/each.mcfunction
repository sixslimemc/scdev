#> scdev:_/main/sc_hook/rebuild/send_error/error/missing_deps/each
#--------------------
# ./send
#--------------------
...
# format from text:
data modify storage scdev:in pack.reference.pack_ref set from storage scdev:_ t.error.this_entry.from.pack_id
...
# author mismatch:
execute if data storage scdev:_ t.error.this_entry.reason.author_mismatch run function scdev:_/main/sc_hook/rebuild/send_error/error/build/missing_deps/author_mismatch
...
execute if data storage scdev:_ t.error.entries[0] run function scdev:_/main/sc_hook/rebuild/send_error/error/build/missing_deps/each