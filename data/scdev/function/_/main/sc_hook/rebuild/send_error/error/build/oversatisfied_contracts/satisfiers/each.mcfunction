#> scdev:_/main/sc_hook/rebuild/send_error/error/missing_paths/packs/each
#--------------------
# ../each
#--------------------
...
execute if data storage scdev:_ t.error.this_entry.satisfiers[0] run function scdev:_/main/sc_hook/rebuild/send_error/error/build/oversatisfied_contracts/satisfiers/each