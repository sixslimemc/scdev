#> scdev:_/main/sc_hook/rebuild/send_error/error/build/preload_conflicts/each_entrypoint
#--------------------
# ./each
#--------------------
...
execute if data storage scdev:_ t.error.this_entry.conflicting_group[0] run function scdev:_/main/sc_hook/rebuild/send_error/error/build/preload_conflicts/each_entrypoint