#> scdev:_/main/sc_hook/rebuild/send_error/error/build/unsatisfied_contracts/send
#--------------------
# ../../../do
#--------------------
...
execute if data storage scdev:_ t.error.entries[0] run function scdev:_/main/sc_hook/rebuild/send_error/error/build/unsatisfied_contracts/each