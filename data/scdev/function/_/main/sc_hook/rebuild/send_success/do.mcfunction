#> scdev:_/main/sc_hook/rebuild/send_success/do
#--------------------
# ../end
#--------------------
...
execute if data storage scdev:_ t.success.build_packs[0] run function scdev:_/main/sc_hook/rebuild/send_success/build_packs/each
...
execute if data storage scdev:_ t.success.installed[0] run function scdev:_/main/sc_hook/rebuild/send_success/installed/each

# add {..installs} to {..enables}:
data modify storage scdev:_ t.success.enables append from storage scdev:_ t.success.installs[].pack

# send message:
execute summon minecraft:text_display run function scdev:_/main/sc_hook/rebuild/send_success/message/do
