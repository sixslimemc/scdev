#> scdev:_/main/sc_hook/rebuild/send_success/send_message/do
#--------------------
# ../do
#--------------------
...
execute if data storage scdev:_ t.success.packs[0] run function scdev:_/main/sc_hook/rebuild/send_success/message/list_packs/each
...
execute if data storage scdev:_ t.success.entries[0] run function scdev:_/main/sc_hook/rebuild/send_success/message/list_entries/each
