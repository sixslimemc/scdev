#> scdev:_/main/sc_hook/safe_mode/start/calls/each
#--------------------
# ../do
#--------------------
...
execute if data storage scdev:_ t.safe_mode.calls[0] run function scdev:_/main/sc_hook/safe_mode/start/calls/each