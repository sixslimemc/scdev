...
data modify storage slimecore:in manifest.pack.url set value "https://github.com/sixslimemc/_namespace_/releases/download/0.1.0/sixslime.scdev%200.1.0.zip"
