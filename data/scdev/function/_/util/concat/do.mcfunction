...
data modify storage scdev:_ u.concat.buffer set from entity @s text.extra
...
# set out:
data modify storage scdev:_/out concat.result set from storage scdev:_ u.concat.acc