...
data modify storage scdev:_ x.mline set value {1:"data modify storage scdev:_ u.pack.data set from storage slimecore:data world.aux.installed_map.", 2:true}
