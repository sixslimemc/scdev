...
execute if data storage scdev:_ u.pack.data run function scdev:_/util/format/pack/in_build
execute unless data storage scdev:_ u.pack.data run function scdev:_/util/format/pack/outside_build
