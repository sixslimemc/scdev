...
data modify storage scdev:_ u.pack.text set value {text:"PACK ID", color:dark_gray, hover_event:{action:"show_text", value:{text:"Pack has not been initialized", color:dark_gray, italic:true}}}
