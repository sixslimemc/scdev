...
data modify storage scdev:_ u.pack.text set value {text:"PACK ID", color:dark_gray, italic:true, hover_event:{action:"show_text", value:{text:"Not present in the current build", color:dark_gray, italic:true}}}
