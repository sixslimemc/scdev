...
data modify storage scdev:_ x.mline set value {1:"data modify storage scdev:_/out click_pack.result.command set value \"function scdev:-/info/pack {pack_id:'", 2:true, 3:"'}\""}
