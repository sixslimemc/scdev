...
execute if data storage scdev:in preload_entrypoint{use_this_entity:true} if entity @s[type=text_display] run scoreboard players set *preload_entrypoint.use_self _scdev 1
