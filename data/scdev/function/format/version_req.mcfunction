...
execute if data storage scdev:in version_req{use_this_entity:true} if entity @s[type=text_display] run scoreboard players set *version_req.use_self _scdev 1
